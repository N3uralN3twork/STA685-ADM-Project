...
```{r, "Plot of Soil Types and Tree Types"}
...
![](https://lh6.googleusercontent.com/wjc2P24BHlsbUawt-XNx4UHaHkprixBtbNdxUulua6Uq6cpd01Y-lzbWqd5FwYLHCNbIKTfvE-uDu0wAKZzDv2CkDyIJxxAlxXe_-bIs2tmjQ6kbJx7mWTrNO0SmPfwrr82kh70)
...
df <- read_csv("covertype.csv", col_names = TRUE, progress = TRUE)
df$Cover_Type = factor(df$class)
```

## Feature Engineering:

```{r, "Feature Engineering"}
#Re-Code PRedictor as string
df <- df %>%
  mutate(CoverName =
           case_when(class == 1 ~ "Spruce.fir",
...
#Re-factor Wilderness Area Predictors into 1 new predictor
df <- df %>%
  mutate(WildernessArea =
           case_when(Wilderness_Area1 == 1 ~ 0,
                     Wilderness_Area2 == 1 ~ 1,
                     Wilderness_Area3 == 1 ~ 2,
                     Wilderness_Area4 == 1 ~ 3,
                     TRUE ~ NaN))


#Re-factor the Soil Type Dummy Predictors into 1 new predictor
df <- df %>%
  mutate(SoilType =
           case_when(Soil_Type1 == 1 ~ 0, Soil_Type40 == 1 ~ 39,
                     Soil_Type2 == 1 ~ 1, Soil_Type3 == 1 ~ 2,
                     Soil_Type4 == 1 ~ 3, Soil_Type5 == 1 ~ 4,
                     Soil_Type6 == 1 ~ 5, Soil_Type7 == 1 ~ 6,
                     Soil_Type8 == 1 ~ 7, Soil_Type9 == 1 ~ 8,
                     Soil_Type10 == 1 ~ 9, Soil_Type11 == 1 ~ 10,
                     Soil_Type12 == 1 ~ 11, Soil_Type13 == 1 ~ 12,
                     Soil_Type14 == 1 ~ 13, Soil_Type15 == 1 ~ 14,
                     Soil_Type16 == 1 ~ 15, Soil_Type17 == 1 ~ 16,
                     Soil_Type18 == 1 ~ 17, Soil_Type19 == 1 ~ 18,
                     Soil_Type20 == 1 ~ 19, Soil_Type21 == 1 ~ 20,
                     Soil_Type22 == 1 ~ 21, Soil_Type23 == 1 ~ 22,
                     Soil_Type24 == 1 ~ 23, Soil_Type25 == 1 ~ 24,
                     Soil_Type26 == 1 ~ 25, Soil_Type27 == 1 ~ 26,
                     Soil_Type28 == 1 ~ 27, Soil_Type29 == 1 ~ 28,
                     Soil_Type30 == 1 ~ 29, Soil_Type31 == 1 ~ 30,
                     Soil_Type32 == 1 ~ 31, Soil_Type33 == 1 ~ 32,
                     Soil_Type34 == 1 ~ 33, Soil_Type35 == 1 ~ 34,
                     Soil_Type36 == 1 ~ 35, Soil_Type37 == 1 ~ 36,
                     Soil_Type38 == 1 ~ 37, Soil_Type39 == 1 ~ 38,
                     TRUE ~ NaN))

#Calculate the Euclidean Distance to Hydrology
df$EuclidDistHydro = sqrt(df$Horizontal_Distance_To_Hydrology^2 + df$Vertical_Distance_To_Hydrology^2)
```
